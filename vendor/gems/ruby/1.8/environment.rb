...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/bundler-0.8.1/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/bundler-0.8.1/lib")
  ...
  @bundled_specs = {}
  @bundled_specs["bundler"] = eval(File.read("#{dir}/specifications/bundler-0.8.1.gemspec"))
  @bundled_specs["bundler"].loaded_from = "#{dir}/specifications/bundler-0.8.1.gemspec"
